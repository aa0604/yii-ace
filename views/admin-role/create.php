                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    <div class="form-group field-form-field-1 required">
                                                        ...
                                                        <input id="form-field-1" class="col-md-offset-1  col-sm-3" name="AdminRole[name]" placeholder="角色名称" aria-required="true" type="text">
                                                    ...
                                                    <div class="form-group field-form-field-1 required"  style="display: none">
                                                        ...
                                                        <input id="form-field-1" class="col-md-offset-1  col-sm-3" name="AdminRole[code]" value="<?=date('YmdHis')?>" readonly="readonly" placeholder="角色编号" aria-required="true" type="text">
...
$js = <<<JAVASCRIP
    ...
    $('.ajaxForm').bind('click',function () {
        ...
        ajaxPullData(data,'/admin/admin-role/create',function (data) {
            if (data.code == 200 ){
