                                            ...
                                            <div class="widget-body">
                                                ...
                                                <div class="widget-main">
                                                    <div class="form-group field-form-field-1 required">
                                                        ...
                                                        <input id="form-field-1" class="col-md-offset-1  col-sm-3" name="AdminUser[username]" placeholder="" aria-required="true" type="text">

                                                        <div class="help-block"></div>
                                                    </div>
                                                    <div class="form-group field-form-field-1">
                                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">*手机:</label>
                                                        <input id="form-field-1" class="col-md-offset-1  col-sm-3" name="AdminUser[mobile]" placeholder="" type="text">
                                                    ...
                                                    <div class="form-group field-adminuser-role_id">
                                                        ...
                                                        <div class="col-md-offset-1  col-sm-3">
                                                            <?php foreach ($dataList as $k=>$v) {?>
                                                                <input type="checkbox" name="AdminUser[role_id][]" value="<?= $k ?>">&nbsp;<?= $v ?>&nbsp;&nbsp;
                                                            <?php }?>
                                                        </div>
                                                        <div class="help-block"></div>
                                                    </div>
...
<!--                                                        <input id="form-field-1" class="col-md-offset-1  col-sm-3" name="AdminUser[code]" onKeyUp="if(this.value.length>4){this.value=this.value.substr(0,4)};this.value=this.value.replace(/[^\d]/g,'');"  placeholder="0000到9999间" aria-required="true" type="text">-->
<!---->
<!--                                                        <div class="help-block"></div>-->
<!--                                                    </div>-->
                                                    <div class="form-group field-form-field-1">
        ...
        $.ajax({
            ...
            success:function (data) {
                layer.msg(data.message,'',function () {
                    if (data.code == 200 ){
                        window.location = '/admin/admin-user/index';
                    }
                });
